...
- Stable: `gluufederation/persistence:4.1.3_01`
- Unstable: `gluufederation/persistence:4.1.3_dev`
...
docker run -d \
    ...
    gluufederation/wrends:4.1.1_03
```
...
docker run --rm \
    ...
    -v /path/to/vault_role_id.txt:/etc/certs/vault_role_id \
    -v /path/to/vault_secret_id.txt:/etc/certs/vault_secret_id \
    gluufederation/persistence:4.1.3_01
```
